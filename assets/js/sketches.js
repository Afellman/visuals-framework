...
class Sin extends Sketch { // Scene 7
  ...
  draw() {
    ...
    beginShape()
    fill(this.color[0] + sin(frameCount * this.colorSpeed) * 50, this.color[1] + sin(frameCount * this.colorSpeed) * 50, this.color[2] + sin(frameCount * this.colorSpeed) * 50, this.opacity);
    for (let i = 0; i < 360; i++) {
